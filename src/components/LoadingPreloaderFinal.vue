<template>
    <div v-if="ativoPreloader" class="loading-preloader" role="status" aria-live="polite">
...
h78.747C231.693,100.736,232.77,106.162,232.77,111.694z"></path>
        ...
        <!-- Loader com palavras animadas -->
        <div class="card">
            <div class="loader">
                <p>Finalizando</p>
                <div class="words">
                    <span class="word">sua compra</span>
                    <span class="word">seu pedido</span>
                    <span class="word">seu pagamento</span>
                    <span class="word">seu momento</span>
                    <span class="word">com muito cuidado</span>
                </div>
            </div>
        </div>

        <!-- opcional: logo ou texto extra -->
        <div class="loading-preloader-extra">
...
const props = defineProps({
    ativoPreloader: { type: Boolean, default: false }
})
</script>
<style scoped>
@import url('https://fonts.googleapis.com/css2?family=BBH+Sans+Bogle&family=Bodoni+Moda:ital,opsz,wght@0,6..96,400..900;1,6..96,400..900&family=Permanent+Marker&display=swap');
...
.rb-loader {
    ...
    font-weight: 900;
    color: #956afa;
    animation: blinkRB 5s infinite ease;
}
...
.words {
    overflow: hidden;
    /* corta o que sai do container */
    display: flex;
    flex-direction: column;
    /* palavras empilhadas verticalmente */
    height: 40px;
    /* mesma altura do loader */
    margin-left: 10px;
    position: relative;
}
